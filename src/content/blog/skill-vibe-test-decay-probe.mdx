...
date: "2026-07-07"
excerpt: "Claude Code skills steer an agent well on turn one. I built skill-vibe-test to check whether the steering survives a long session, pointed it at one of my own skills, and had to throw most of the result away. Here is the part that held up, and how I know which part that is."
