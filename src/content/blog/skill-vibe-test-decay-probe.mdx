...
date: "2026-07-07"
excerpt: "Claude Code skills steer an agent well on turn one. I built skill-vibe-test to check whether the steering survives a long session, pointed it at one of my own skills, and had to throw most of the result away. The part that held up: by turn 6 the agent had stopped running the script the skill prescribes. The skill did not stop working. It stopped being consulted."
...
That's a degradation in the behavior the skill was written to produce, and it is visible in the raw tool trace of the saved transcripts without agreeing with a single one of the judge's verdicts. It's a smaller claim than the one I originally made. It's the one I can defend.
