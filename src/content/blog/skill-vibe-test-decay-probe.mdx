...
![Chart titled "skill-vibe-test: does capabilities-health still steer sonnet as context fills?" plotting two conversations across baseline, turn 6, turn 8 and turn 10. Both lines sit flat on the FAIL axis at every probe point, with no point anywhere near PASS. Red X markers mark escape hatches at turns 6 and 8. A red banner across the top of the plot reads "BASELINE GATE BYPASSED: turn 1 already failed, so this is not a decay curve".](/images/blog/skill-vibe-test-decay-probe/decay-flatline.png)
