...
opener: "My Tic-Tac-Toe ships six themes that repaint the board, the buttons, the HUD and the music from one menu tap, and adding a seventh is one ScriptableObject and zero new code. This entry is the architecture behind that, and why splitting a theme into five interfaces was the move that made theming a data problem instead of a code problem."
